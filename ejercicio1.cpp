...
/*
Crear una aplicacion en c++(.cpp) que lleve el control de ingresos de cajas en un almacén,
cada caja se ingresará en orden y las más importantes se procuraran dejar de ultimo de modo 
que no cueste despachar. La información más importante de las cajas será su código de la caja. 
Cuando se finaliza el ingreso, se procede a despachar las cajas, 
respetando el orden que las ultimas cajas que ingresaron son las mas importantes 
y deben salir de primero hacia cada repartidor.
